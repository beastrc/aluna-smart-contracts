 ...
 *
 * - Based on 
 * https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v2.4.0/contracts/drafts/TokenVesting.sol
 * - Adapted in order to be upgradable
 * - Added vested and releasable methods
 */
